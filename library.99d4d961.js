 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jn=new qe(3e4,6e4);function Kn(){const e=mn().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Yn=null;function Qn(e){return Yn=Yn||function(e){return new Promise(((t,n)=>{var i,r,o;function a(){Kn(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Kn(),n(De(e,"network-request-failed"))},timeout:Jn.get()})}if(null===(r=null===(i=mn().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=mn().gapi)||void 0===o?void 0:o.load)){const t=En("iframefcb");return mn()[t]=()=>{gapi.load?a():n(De(e,"network-request-failed"))},Nn(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}a()}})).catch((e=>{throw Yn=null,e}))}(e),Yn}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
function(e=ge()){const t=pe(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=pe(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(I(n.getOptions(),null!=t?t:{}))return e;Oe(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:si,persistence:[In,cn,fn]})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw he.create("bad-app-name",{appName:String(i)});const r=ce.get(i);if(r){if(I(e,r.options)&&I(n,r.config))return r;throw he.create("duplicate-app",{appName:i})}const o=new D(i);for(const e of ue.values())o.addComponent(e);const a=new me(e,n,o);return ce.set(i,a),a}({apiKey:"AIzaSyBwIHbipBLGGO3rbF9X_3hWkD1LKg_9nto",authDomain:"filmoteka-auth-d1821.firebaseapp.com",projectId:"filmoteka-auth-d1821",storageBucket:"filmoteka-auth-d1821.appspot.com",messagingSenderId:"528877394896",appId:"1:528877394896:web:a8dabe5ad1904b525c77d5"})),fi=(ui.currentUser,document.querySelector(".auth-btn")),di=document.querySelector(".logout__btn"),pi=document.querySelector(".container__form"),hi=(document.querySelector(".row"),document.querySelector(".backdrop"),document.querySelector(".fa-solid"),document.querySelector(".form-check-input")),mi=document.querySelector(".btn__signup"),gi=document.querySelector(".btn__login"),yi=document.querySelector(".form");let bi=document.querySelector("#firstPass");document.querySelector("#repeatedPass"),document.querySelector("#userName");let vi=document.querySelector("#userEmail");document.querySelector(".login__link");const wi=document.querySelector(".library-link");function xi(e){if(e.preventDefault(),bi.value.length<6)t(u).Notify.failure("Password should be at least 6 characters");else if(0===vi.value.length)t(u).Notify.failure("Please enter Your email address");else{const e=vi.value,n=bi.value;!async function(e,n,i){try{const r=await on(e,n,i);t(u).Notify.success("User created"),console.log(r.user)}catch(e){console.log(e),t(u).Notify.warning("User already created, please procced to Log In page")}}(ui,e,n),yi.reset(),pi.classList.add("invis")}}function ki(e){(e.target.classList.contains("fa-solid")||e.target===e.currentTarget)&&(pi.classList.add("invis"),window.removeEventListener("keydown",Ii),pi.removeEventListener("click",ki))}function Ii(e){"Escape"===e.code&&pi.classList.add("invis")}function Ni(){hi.checked?(mi.disabled=!1,mi.style.border="1px black solid"):mi.disabled=!0}function Ei(e){e.preventDefault();const t=vi.value,n=bi.value;localStorage.setItem("userData",JSON.stringify({userEmail:t,userPassword:n}));_i(ui,t,n),yi.reset(),pi.classList.add("invis")}async function _i(e,n,i){try{await an(e,n,i);t(u).Notify.success("You are In"),wi.removeEventListener("click",Ti)}catch(e){console.log(e),t(u).Notify.warning("User is not found. Or user data do not match ours records")}}function Ti(e){e.preventDefault(),t(u).Notify.warning('To use "Mi Library" page. First You need to login')}wi.addEventListener("click",Ti),mi.disabled=!0,function(){if(localStorage.getItem("userData")){const e=JSON.parse(localStorage.getItem("userData")),{userEmail:t,userPassword:n}=e;_i(ui,t,n)}}(),fi.addEventListener("click",(function(){pi.classList.remove("invis"),window.addEventListener("keydown",Ii),pi.addEventListener("click",ki),gi.addEventListener("click",Ei),yi.addEventListener("submit",xi),Ni()})),hi.addEventListener("change",Ni),di.addEventListener("click",(function(){localStorage.getItem("userData")&&(e=ui,A(e).signOut()).then((()=>{t(u).Notify.success("Sign-out successful."),wi.addEventListener("click",Ti),localStorage.removeItem("userData")})).catch((e=>{t(u).Notify.warning("Sign-out unsuccessful.")}));var e})),o("lpYGl"),o("dc83a");var Si=o("2shzp"),Ci=o("2HWav");async function Ri(e,n){const i=`https://api.themoviedb.org/3/search/movie?api_key=9c40587b7d16ffbdc73a57b7c7629b49&query=${e}&page=${n}`;(0,Ci.preLoader)();try{const e=await t(Si).get(i);return e.data.results}catch(e){console.log(e)}}var Ai=o("f8b2m"),Li=o("bTcpz");Ci=o("2HWav");t(u).Notify.init({width:"280px",position:"center-top",closeButton:!1,useIcon:!1,fontFamily:"Roboto",clickToClose:"true",fontSize:"12px"});const Oi=document.querySelector(".gallery-films"),Di=document.querySelector("#movie-search");let Mi="",Bi=1;Di&&Di.addEventListener("submit",(async function(e){if(e.preventDefault(),Mi=e.currentTarget.query.value.trim(),Bi=1,""===Mi)return void t(u).Notify.failure("This field cannot be empty!");try{!async function(){const e=await Ri(Mi,Bi),n=await(0,Ai.createCards)(e);if(console.log("films",e),0===e.length)return void t(u).Notify.failure("Search result not successful, try something else.");async function i(e){e.preventDefault(e);const t=Number(e.target.parentElement.attributes[1].value);(0,Li.fechFilm)(t)}Oi.innerHTML="",Oi.insertAdjacentHTML("beforeend",n),Oi.addEventListener("click",i),Bi+=1,(0,Ci.preLoaderDel)()}()}catch(e){t(u).Notify.failure("Ooops...Something goes wrong")}})),o("f8b2m");
//# sourceMappingURL=library.99d4d961.js.map
