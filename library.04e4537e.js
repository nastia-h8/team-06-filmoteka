 ...
 * limitations under the License.
 */
function hn(e,t){return P(e).setPersistence(t)}function mn(e,t,n,i){return P(e).onAuthStateChanged(t,n,i)}new WeakMap;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn extends gn{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}vn.type="SESSION";const wn=vn;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function En(){return void 0!==Nn().WorkerGlobalScope&&"function"==typeof Nn().importScripts}class _n{toPromise(){return new Promise(((e,t)=>{this.request.addEventListener("success",(()=>{e(this.request.result)})),this.request.addEventListener("error",(()=>{t(this.request.error)}))}))}constructor(e){this.request=e}}function Sn(e,t){return e.transaction(["firebaseLocalStorage"],t?"readwrite":"readonly").objectStore("firebaseLocalStorage")}function Tn(){const e=indexedDB.open("firebaseLocalStorageDb",1);return new Promise(((t,n)=>{e.addEventListener("error",(()=>{n(e.error)})),e.addEventListener("upgradeneeded",(()=>{const t=e.result;try{t.createObjectStore("firebaseLocalStorage",{keyPath:"fbase_key"})}catch(e){n(e)}})),e.addEventListener("success",(async()=>{const n=e.result;n.objectStoreNames.contains("firebaseLocalStorage")?t(n):(n.close(),await function(){const e=indexedDB.deleteDatabase("firebaseLocalStorageDb");return new _n(e).toPromise()}(),t(await Tn()))}))}))}async function Cn(e,t,n){const i=Sn(e,!0).put({fbase_key:t,value:n});return new _n(i).toPromise()}function Rn(e,t){const n=Sn(e,!0).delete(t);return new _n(n).toPromise()}class An{async _openDb(){return this.db||(this.db=await Tn()),this.db}async _withRetries(e){let t=0;for(;;)try{const t=await this._openDb();return await e(t)}catch(e){if(t++>3)throw e;this.db&&(this.db.close(),this.db=void 0)}}async initializeServiceWorkerMessaging(){return En()?this.initializeReceiver():this.initializeSender()}async initializeReceiver(){this.receiver=xn._getInstance(En()?self:null),this.receiver._subscribe("keyChanged",(async(e,t)=>({keyProcessed:(await this._poll()).includes(t.key)}))),this.receiver._subscribe("ping",(async(e,t)=>["keyChanged"]))}async initializeSender(){var e,t;if(this.activeServiceWorker=await async function(){if(!(null===navigator||void 0===navigator?void 0:navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch(e){return null}}(),!this.activeServiceWorker)return;this.sender=new In(this.activeServiceWorker);const n=await this.sender._send("ping",{},800);n&&(null===(e=n[0])||void 0===e?void 0:e.fulfilled)&&(null===(t=n[0])||void 0===t?void 0:t.value.includes("keyChanged"))&&(this.serviceWorkerReceiverAvailable=!0)}async notifyServiceWorker(e){var t;if(this.sender&&this.activeServiceWorker&&((null===(t=null===navigator||void 0===navigator?void 0:navigator.serviceWorker)||void 0===t?void 0:t.controller)||null)===this.activeServiceWorker)try{await this.sender._send("keyChanged",{key:e},this.serviceWorkerReceiverAvailable?800:50)}catch(t){}}async _isAvailable(){try{if(!indexedDB)return!1;const e=await Tn();return await Cn(e,"__sak","1"),await Rn(e,"__sak"),!0}catch(e){}return!1}async _withPendingWrite(e){this.pendingWrites++;try{await e()}finally{this.pendingWrites--}}async _set(e,t){return this._withPendingWrite((async()=>(await this._withRetries((n=>Cn(n,e,t))),this.localCache[e]=t,this.notifyServiceWorker(e))))}async _get(e){const t=await this._withRetries((t=>async function(e,t){const n=Sn(e,!1).get(t),i=await new _n(n).toPromise();return void 0===i?null:i.value}(t,e)));return this.localCache[e]=t,t}async _remove(e){return this._withPendingWrite((async()=>(await this._withRetries((t=>Rn(t,e))),delete this.localCache[e],this.notifyServiceWorker(e))))}async _poll(){const e=await this._withRetries((e=>{const t=Sn(e,!1).getAll();return new _n(t).toPromise()}));if(!e)return[];if(0!==this.pendingWrites)return[];const t=[],n=new Set;for(const{fbase_key:i,value:r}of e)n.add(i),JSON.stringify(this.localCache[i])!==JSON.stringify(r)&&(this.notifyListeners(i,r),t.push(i));for(const e of Object.keys(this.localCache))this.localCache[e]&&!n.has(e)&&(this.notifyListeners(e,null),t.push(e));return t}notifyListeners(e,t){this.localCache[e]=t;const n=this.listeners[e];if(n)for(const e of Array.from(n))e(t)}startPolling(){this.stopPolling(),this.pollTimer=setInterval((async()=>this._poll()),800)}stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}_addListener(e,t){0===Object.keys(this.listeners).length&&this.startPolling(),this.listeners[e]||(this.listeners[e]=new Set,this._get(e)),this.listeners[e].add(t)}_removeListener(e,t){this.listeners[e]&&(this.listeners[e].delete(t),0===this.listeners[e].size&&delete this.listeners[e]),0===Object.keys(this.listeners).length&&this.stopPolling()}constructor(){this.type="LOCAL",this._shouldAllowMigration=!0,this.listeners={},this.localCache={},this.pollTimer=null,this.pendingWrites=0,this.receiver=null,this.sender=null,this.serviceWorkerReceiverAvailable=!1,this.activeServiceWorker=null,this._workerInitializationPromise=this.initializeServiceWorkerMessaging().then((()=>{}),(()=>{}))}}An.type="LOCAL";const Ln=An;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var r,o;i.setAttribute("src",e),i.onload=t,i.onerror=e=>{const t=We("internal-error");t.customData=e,n(t)},i.type="text/javascript",i.charset="UTF-8",(null!==(o=null===(r=document.getElementsByTagName("head"))||void 0===r?void 0:r[0])&&void 0!==o?o:document).appendChild(i)}))}function Dn(e){return`__${e}${Math.floor(1e6*Math.random())}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Dn("rcb"),new Ze(3e4,6e4);async function Mn(e,t,n){var i;const r=await n.verify();try{let o;if(Ve("string"==typeof r,e,"argument-error"),Ve("recaptcha"===n.type,e,"argument-error"),o="string"==typeof t?{phoneNumber:t}:t,"session"in o){const t=o.session;if("phoneNumber"in o){Ve("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function zn(e,t){return t?Ge(t):(Ve(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Bn.PROVIDER_ID="phone",Bn.PHONE_SIGN_IN_METHOD="phone";class Pn extends Wt{_getIdTokenResponse(e){return Vt(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Vt(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Vt(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function Un(e){return un(e.auth,new Pn(e),e.bypassAuthState)}function jn(e){const{auth:t,user:n}=e;return Ve(n,t,"internal-error"),cn(n,new Pn(e),e.bypassAuthState)}async function Wn(e){const{auth:t,user:n}=e;return Ve(n,t,"internal-error"),ln(n,new Pn(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kn(e,t,n=!1){const i=Ut(e),r=zn(i,t),o=new qn(i,r,n),a=await o.execute();return a&&!n&&(delete a.user._redirectEventId,await i._persistUserIfCurrent(a.user),await i._setRedirectUser(null,t)),a}class Yn{registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach((n=>{this.isEventForConsumer(e,n)&&(t=!0,this.sendToConsumer(e,n),this.saveEventToCache(e))})),this.hasHandledPotentialRedirect||!function(e){switch(e.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Zn(e);default:return!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ri=new Ze(3e4,6e4);function oi(){const e=Nn().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let ai=null;function si(e){return ai=ai||function(e){return new Promise(((t,n)=>{var i,r,o;function a(){oi(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{oi(),n(We(e,"network-request-failed"))},timeout:ri.get()})}if(null===(r=null===(i=Nn().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Nn().gapi)||void 0===o?void 0:o.load)){const t=Dn("iframefcb");return Nn()[t]=()=>{gapi.load?a():n(We(e,"network-request-failed"))},On(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}a()}})).catch((e=>{throw ai=null,e}))}(e),ai}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${L(s).slice(1)}`}const gi=class{async _openPopup(e,t,n,i){var r;qe(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return hi(e,mi(e,t,n,Je(),i),kn())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=mi(e,t,n,Je(),i),Nn().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(qe(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await si(e),n=Nn().gapi;return Ve(n,e,"internal-error"),t.open({where:document.body,url:fi(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:ci,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=We(e,"network-request-failed"),o=Nn().setTimeout((()=>{i(r)}),li.get());function a(){Nn().clearTimeout(o),n(t)}t.ping(a).then(a,(()=>{i(r)}))}))))}(e),n=new Yn(e);return t.register("authEvent",(t=>{Ve(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),je(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=ni(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Mt()||St()||Ot()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=wn,this._completeRedirectFn=Kn,this._overrideRedirectResult=$n}};var yi;
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function vi(e=Ie()){const t=we(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=we(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(R(n.getOptions(),null!=t?t:{}))return e;je(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:gi,persistence:[Ln,bn,wn]})}yi="Browser",ve(new U("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:r,authDomain:o}=n.options;return((e,n)=>{Ve(r&&!r.includes(":"),"invalid-api-key",{appName:e.name}),Ve(!(null==o?void 0:o.includes(":")),"argument-error",{appName:e.name});const i={apiKey:r,authDomain:o,clientPlatform:yi,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Bt(yi)},a=new Pt(e,n,i);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(Ge);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(a,t),a})(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),ve(new U("auth-internal",(e=>{const t=Ut(e.getProvider("auth").getImmediate());return new bi(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Ne("@firebase/auth","0.20.5",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(yi)),Ne("@firebase/auth","0.20.5","esm2017");const wi=function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw xe.create("bad-app-name",{appName:String(i)});const r=ge.get(i);if(r){if(R(e,r.options)&&R(n,r.config))return r;throw xe.create("duplicate-app",{appName:i})}const o=new W(i);for(const e of ye.values())o.addComponent(e);const a=new ke(e,n,o);return ge.set(i,a),a}({apiKey:"AIzaSyBwIHbipBLGGO3rbF9X_3hWkD1LKg_9nto",authDomain:"filmoteka-auth-d1821.firebaseapp.com",projectId:"filmoteka-auth-d1821",storageBucket:"filmoteka-auth-d1821.appspot.com",messagingSenderId:"528877394896",appId:"1:528877394896:web:a8dabe5ad1904b525c77d5"}),xi=vi(wi);xi.currentUser;const ki=document.querySelector(".auth-btn"),Ii=document.querySelector(".logout__btn"),Ni=document.querySelector(".container__form"),Ei=(document.querySelector(".row"),document.querySelector(".backdrop"),document.querySelector(".fa-solid"),document.querySelector(".form-check-input")),_i=document.querySelector(".btn__signup"),Si=document.querySelector(".btn__login"),Ti=document.querySelector(".form");let Ci=document.querySelector("#firstPass");document.querySelector("#repeatedPass"),document.querySelector("#userName");let Ri=document.querySelector("#userEmail");document.querySelector(".login__link");let Ai=document.querySelector(".library-link");function Li(e){if(e.preventDefault(),Ci.value.length<6)t(y).Notify.failure("Password should be at least 6 characters");else if(0===Ri.value.length)t(y).Notify.failure("Please enter Your email address");else{const e=Ri.value,n=Ci.value;!async function(e,n,i){try{await dn(e,n,i);t(y).Notify.success("User created"),Ii.disabled=!1}catch(e){console.log(e),t(y).Notify.warning("User already created, please procced to Log In page")}}(xi,e,n),Ti.reset(),Ni.classList.add("invis")}}function Oi(e){(e.target.classList.contains("fa-solid")||e.target===e.currentTarget)&&(Ni.classList.add("invis"),window.removeEventListener("keydown",Di),Ni.removeEventListener("click",Oi))}function Di(e){"Escape"===e.code&&Ni.classList.add("invis")}function Mi(){Ei.checked?(_i.disabled=!1,_i.style.border="1px black solid"):_i.disabled=!0}function Bi(e){e.preventDefault();const n=Ri.value,i=Ci.value;!async function(e,n,i){try{e=vi(wi),await hn(e,bn),await pn(e,n,i),async function(){mn(vi(wi),(e=>{e?(t(y).Notify.success("You are loged in"),Ii.disabled=!1,console.log(e)):(t(y).Notify.failure("Does not work"),console.log(e))}))}(),Ai.removeEventListener("click",zi)}catch(e){console.log(e),t(y).Notify.warning("User is not found. Or user data do not match ours records")}}(xi,n,i),Ti.reset(),Ni.classList.add("invis")}function zi(e){e.preventDefault(),t(y).Notify.info('To use "Mi Library" page. First You need to login')}Ai.addEventListener("click",zi),_i.disabled=!0,ki.addEventListener("click",(function(){Ni.classList.remove("invis"),window.addEventListener("keydown",Di),Ni.addEventListener("click",Oi),Si.addEventListener("click",Bi),Ti.addEventListener("submit",Li),Mi()})),Ei.addEventListener("change",Mi),Ii.addEventListener("click",(function(){(e=xi,P(e).signOut()).then((()=>{t(y).Notify.success("Sign-out successful."),Ai.addEventListener("click",zi),Ii.disabled=!0})).catch((e=>{t(y).Notify.warning("Sign-out unsuccessful.")}));var e})),mn(vi(wi),(e=>{e?Ai.removeEventListener("click",zi):Ai.addEventListener("click",zi)})),o("lpYGl"),o("dc83a");var Pi=o("2shzp");async function Ui(e,n){const i=`https://api.themoviedb.org/3/search/movie?api_key=9c40587b7d16ffbdc73a57b7c7629b49&query=${e}&page=${n}`;u.Loading.custom({customSvgCode:'<div class="preloader-dev">\n        <div class="preloader-dev__row">\n            <div class="preloader-dev__item"></div>\n            <div class="preloader-dev__item"></div>\n        </div>\n    </div>'});try{const e=await t(Pi).get(i);return e.data.results}catch(e){console.log(e)}}var ji=o("f8b2m"),Wi=o("bTcpz");t(y).Notify.init({width:"280px",position:"center-top",closeButton:!1,useIcon:!1,fontFamily:"Roboto",clickToClose:"true",fontSize:"12px"});const Fi=document.querySelector(".gallery-films"),Hi=document.querySelector("#movie-search");let Vi="",Xi=1;Hi&&Hi.addEventListener("submit",(async function(e){if(e.preventDefault(),Vi=e.currentTarget.query.value.trim(),Xi=1,""===Vi)return void t(y).Notify.failure("This field cannot be empty!");try{!async function(){const e=await Ui(Vi,Xi),n=await(0,ji.createCards)(e);if(console.log("films",e),0===e.length)return void t(y).Notify.failure("Search result not successful, try something else.");async function i(e){e.preventDefault(e);const t=Number(e.target.parentElement.attributes[1].value);(0,Wi.fechFilm)(t)}Fi.innerHTML="",Fi.insertAdjacentHTML("beforeend",n),Fi.addEventListener("click",i),Xi+=1,h()}()}catch(e){t(y).Notify.failure("Ooops...Something goes wrong")}})),o("f8b2m");const qi=document.querySelector('[data-action="open-modal"]'),$i=document.querySelector('[data-action="close-modal"]'),Gi=document.querySelector(".team-backdrop");function Ji(){window.removeEventListener("keydown",Ki),document.body.classList.remove("show-modal")}function Ki(e){"Escape"===e.code&&Ji()}qi.addEventListener("click",(function(){window.addEventListener("keydown",Ki),document.body.classList.add("show-modal")})),$i.addEventListener("click",Ji),Gi.addEventListener("click",(function(e){e.currentTarget===e.target&&Ji()}));
//# sourceMappingURL=library.04e4537e.js.map
